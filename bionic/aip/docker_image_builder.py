...
def fix_pip_requirements(pip_requirements) -> str:
...
def build_image(docker_client, pip_requirements, image_uri):
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        docker_client.images.build(path=tmp_dir, tag=f"{image_uri}")
...
def build_image_if_missing(project_name: str) -> str:
    ...
    try:
        ...
        build_image(docker_client, pip_requirements, image_uri)
